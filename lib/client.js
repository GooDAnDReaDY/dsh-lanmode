      ...
      return React.createElement(
        ...
        open && React.createElement(
                  ...
                  React.createElement(
                    ...
                    devices.map(function (dev) {
                      ...
                      return React.createElement(
                        ...
                        React.createElement('td', { style: { maxWidth: '160px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }, title: dev.userAgent }, dev.userAgent || 'Web Client'),
                        React.createElement('td', null, dev.lastSeen ? new Date(dev.lastSeen).toLocaleTimeString() : '--'),
                        React.createElement(
                          'td',
          ...
          React.createElement(
            ...
            React.createElement(
              'div',
              { style: { marginTop: '16px', paddingTop: '16px', borderTop: '1px solid var(--dsw-alias-border-l2, rgba(0,0,0,0.08))' } },
              React.createElement(
                'div',
              ...
              React.createElement(
                'div',
                {
                  style: {
                    padding: '12px 14px',
                    background: 'var(--dsw-alias-surface-muted, rgba(0,0,0,0.02))',
                    borderRadius: '8px',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement('span', { style: { color: 'var(--dsw-alias-label-secondary, #666)' } }, translate('updaterCurrentVersion')),
                    React.createElement(
                      'span',
                    ...
                    updater && updater.checking && React.createElement(
                      'span',
                      { style: { color: 'var(--dsw-alias-label-tertiary, #999)', fontSize: '11px' } },
          ...
          React.createElement(
            ...
            React.createElement(
              'a',
              {
                ...
                rel: 'noreferrer',
                className: 'lm-hint',
                style: { textDecoration: 'none', color: 'var(--dsw-alias-state-brand-primary, #6366f1)', fontWeight: 500 },
              },
