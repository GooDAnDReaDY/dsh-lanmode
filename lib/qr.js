...
// Внутренний LRU-кэш для сгенерированных SVG QR-кодов (#117)
const QR_CACHE_MAX = 50
const qrSvgCache = new Map()

/**
 * Сгенерировать чистый SVG QR-кода с прозрачным кэшированием в памяти (#117).
 * @param {string} text Текст/URL для кодирования
 * @param {object} [options] Опции генерации (margin, size, dark, light)
 * @returns {string} Валидная строка SVG
 */
...
/**
 * Очистить кэш QR SVG (для тестов и освобождения памяти).
 */
