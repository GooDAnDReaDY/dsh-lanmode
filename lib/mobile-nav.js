// Мобильная навигация, свайп-жесты сайдбара и FAB (Блок 2)
...
// #100, #112: Исключение агрессивного перехвата Enter; точное определение тач-устройств через pointer: coarse
...
export function mobileNavSource() {
  ...
  // #112: Точная проверка сенсорного устройства (coarse pointer) во избежание ложного срабатывания на десктопах с тач-панелью
  ...
  // Мобильные сценарии (свайпы, плавающий FAB) активны только при узком экране и сенсорном указателе, либо при реальном touch-вводе
